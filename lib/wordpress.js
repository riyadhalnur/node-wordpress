...
//yoast specific implementation
extend (Client.prototype, {
  getYoastAnalysis: function( postId, seoData, fn ){
    ...
    if(typeof postId === 'undefined'){
      throw new Error('Post ID ismissing');
    }
    ...
    this.authenticatedCall( "nc.getYoastAnalysis", postId, seoData, function(error, report){
      if( error ){
        return fn( error );
      }
      return fn(null, report);
    });
  }
});
